using Websitekitchenofmen.Models;
using System;
...
namespace Websitekitchenofmen.Controllers
{
    public class UserController : Controller
    {
        ...
        #region Đăng nhập ko cần tk tài khoản người dùng
        [HttpPost]
        public ActionResult dangkymoi999(DangKyModel model)
        {
            { 
                {                  
                    var kh = new KHACHHANG();
